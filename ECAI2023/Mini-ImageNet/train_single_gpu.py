...
def main(args):
    ...
    # optimizer = NHBAdp(pg,lr = args.lr, delta = 1e-2, weight_decay=4e-5)
    # optimizer = optimizer = optim.Adam(pg, lr=args.lr, betas=(0.9, 0.999),
    #         eps=1e-08, weight_decay=4e-5)
    optimizer = optim.AdamW(pg, lr=0.0001, betas=(0.9, 0.999),
            eps=1e-08, weight_decay=4e-5, amsgrad=False)
...
if __name__ == '__main__':
    ...
    # 数据集所在根目录
    parser.add_argument('--data-path', type=str, default="./mini-imagenet/")
